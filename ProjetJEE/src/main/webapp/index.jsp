              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="scroll-to-section"><a href="#courses">Evénements</a></li>
                          <li class="scroll-to-section"><a href="#testimonials">A propos</a></li> 
                          <li class="scroll-to-section"><a href="#contact-section">Contacter-Nous</a></li> 
                           <li class="has-sub">
